...
<html>
    <head>
        ...
        <script>
            ...
            if (referrerUri.startsWith('https://info.cfde.cloud')) {
        ...
        <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&family=Hanken+Grotesk:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <div class="pf-c-page" id="page-layout-default-nav">
      <header role="banner" class="pf-c-page__header">
        <div class="pf-c-page__header-brand">
          ...
          <a id="landingLogo" class="pf-c-page__header-brand-link" href="${referrer_uri}">
          <#elseif properties.logoUrl?has_content>
        ...
        <div class="pf-c-page__header-tools">
            ...
            <div class="pf-c-page__header-tools-group pf-m-icons pf-u-display-none pf-u-display-flex-on-md pf-u-mr-md">
              ...
              <#if properties.logoutUrl?has_content>
              <button id="landingSignOutButton" tabindex="0" style="display:none" onclick="keycloak.logout({redirectUri:'${properties.logoutUrl}'});" class="pf-c-button pf-m-primary" type="button">${msg("doSignOut")}</button>
              <#else>
                ...
                <div id="landingMobileKebab" class="pf-c-dropdown pf-m-mobile" onclick="toggleMobileDropdown();"> <!-- pf-m-expanded -->
                    ...
                    <ul id="landingMobileDropdown" aria-labelledby="landingMobileKebabButton" class="pf-c-dropdown__menu pf-m-align-right" role="menu" style="display:none">
                        ...
                        <li id="landingSignOutLink" role="none" style="display:none">
                            <#if properties.logoutUrl?has_content>
                            <a onclick="keycloak.logout({redirectUri:'${properties.logoutUrl}'});" role="menuitem" tabindex="0" aria-disabled="false" class="pf-c-dropdown__menu-item">${msg("doSignOut")}</a>
                            <#else>
