...
> = new Map([
  ...
  [
    GENE_LABEL,
    new Map([
      [HAS_SOURCE_TYPE, [NCBI_TAXONOMY_LABEL]],
      [ASSOCIATED_WITH_TYPE, [PHENOTYPE_LABEL]],
    ]),
  ],
  [
    ID_NAMESPACE_LABEL,
...
export const PATHWAY_OUTGOING_CONNECTIONS: ReadonlyMap<
  string,
  ReadonlyMap<string, string[]>
> = new Map([
  [BIOSAMPLE_LABEL, new Map([[SAMPLED_FROM_TYPE, [SUBJECT_LABEL]]])],
  [
    COLLECTION_LABEL,
    new Map([
      [CONTAINS_TYPE, [...CORE_LABELS]],
      [DEFINED_BY_TYPE, [PROJECT_LABEL]],
    ]),
  ],
  [FILE_LABEL, new Map([[DESCRIBES_TYPE, [BIOSAMPLE_LABEL, SUBJECT_LABEL]]])],
  [
    GENE_LABEL,
    new Map([
      [HAS_SOURCE_TYPE, [NCBI_TAXONOMY_LABEL]],
  ...
  [
    PROJECT_LABEL,
    new Map([[CONTAINS_TYPE, [BIOSAMPLE_LABEL, FILE_LABEL, SUBJECT_LABEL]]]),
  ],
  [PROTEIN_LABEL, new Map([[HAS_SOURCE_TYPE, [NCBI_TAXONOMY_LABEL]]])],
  [SUBSTANCE_LABEL, new Map([[ASSOCIATED_WITH_TYPE, [COMPOUND_LABEL]]])],
]);

export const PATHWAY_INCOMING_CONNECTIONS: ReadonlyMap<
  string,
  ReadonlyMap<string, string[]>
> = new Map([
  [ANATOMY_LABEL, new Map([[SAMPLED_FROM_TYPE, [BIOSAMPLE_LABEL]]])],
  [
    BIOSAMPLE_LABEL,
    new Map([
      [CONTAINS_TYPE, [COLLECTION_LABEL, PROJECT_LABEL]],
      [DESCRIBES_TYPE, [FILE_LABEL]],
    ]),
  ],
  [COMPOUND_LABEL, new Map([[ASSOCIATED_WITH_TYPE, [SUBSTANCE_LABEL]]])],
  [
    DISEASE_LABEL,
    new Map([[TESTED_FOR_TYPE, [BIOSAMPLE_LABEL, SUBJECT_LABEL]]]),
  ],
  [FILE_LABEL, new Map([[CONTAINS_TYPE, [COLLECTION_LABEL, PROJECT_LABEL]]])],
  [PHENOTYPE_LABEL, new Map([[ASSOCIATED_WITH_TYPE, [GENE_LABEL]]])],
  [PROJECT_LABEL, new Map([[DEFINED_BY_TYPE, [COLLECTION_LABEL]]])],
  [
    SUBJECT_LABEL,
    new Map([
      [CONTAINS_TYPE, [COLLECTION_LABEL, PROJECT_LABEL]],
      [DESCRIBES_TYPE, [FILE_LABEL]],
      [SAMPLED_FROM_TYPE, [BIOSAMPLE_LABEL]],
    ]),
  ],
  [
    NCBI_TAXONOMY_LABEL,
    new Map([
      [ASSOCIATED_WITH_TYPE, [SUBJECT_LABEL]],
      [HAS_SOURCE_TYPE, [GENE_LABEL, PROTEIN_LABEL]],
    ]),
  ],
]);
