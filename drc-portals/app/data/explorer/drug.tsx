    ...
    <CardContent>
        ...
        <Grid item xs={12}>
          <Stack direction={"row"} spacing={1} alignItems={"center"}>
            <Avatar sx={{backgroundColor: lime[100], color: 'black'}}><Icon path={mdiPill} size={2}/></Avatar>
            <Typography variant='h3'>Small Molecules, Drugs, and Metabolites</Typography>
          </Stack>
        </Grid>
        <Grid item xs={12}>
          <Autocomplete
              ...
              onChange={(e: any, newValue: any) => {
                      ...
                      // else setTerm('')
                      if (newValue) {
                        data.update_input('drug', newValue, 'add')
                        setInputTerm('')
                      }
                  }
              }
              ...
              renderInput={(params) => <TextField placeholder='Enter small molecule name' {...params} label="Enter Small Molecule Name" />}
          />
        </Grid>
	    </Grid>
    </CardContent>
