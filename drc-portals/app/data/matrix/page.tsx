...
export default async function DataMatrix() {
  ...
  return (
    <Grid spacing={1}>
      <Grid item xs={12}>
        <Typography variant="h2" color="secondary" sx={{mt:2, ml: 1}} gutterBottom>Metadata & Processed Data Matrix</Typography>
      </Grid>
      <Grid item xs={12}>
        <Typography variant={'subtitle1'} sx={{mt:2, mb:2, ml: 1}}>
