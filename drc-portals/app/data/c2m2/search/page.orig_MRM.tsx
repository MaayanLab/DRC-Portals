...
// Mano: Trying to nake the prisma/sql part more readable
export default async function Page(props: PageProps) {
  ...
  const [results] = searchParams.q ? await prisma.$queryRaw<Array<{
    ...
    Prisma.sql`"results"."dcc_" = ${t.entity_type}`
    : Prisma.sql`(${t.entity_type ? Prisma.sql` and "results"."species_name" = ${t.entity_type}` : Prisma.empty})`), ' or ')}
      ` : Prisma.empty}
