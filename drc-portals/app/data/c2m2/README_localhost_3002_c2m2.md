...
http://localhost:3002/data/c2m2/search/liver?p=1&t=dcc%3AStimulating+Peripheral+Activity+to+Relieve+Conditions
...
Filter: ERCC || HMP
http://localhost:3002/data/c2m2/search/liver?p=1&t=dcc%3AThe+Extracellular+Communication+Consortium+Data+Coordination+Center%7Cdcc%3AHuBMAP
...
Search liver:
http://localhost:3002/data/c2m2/search/liver?p=1

Apply DCC filter (after selecting one or more values for a filter, click outside the filter area):
http://localhost:3002/data/c2m2/search/liver?p=1&t=dcc%3AUCSD+Metabolomics+Workbench

Apply Species filter (select two values: Homo sapiens and Mus musculus):
http://localhost:3002/data/c2m2/search/liver?p=1&t=dcc%3AUCSD+Metabolomics+Workbench%7Cncbi_taxonomy%3AHomo+sapiens%7Cncbi_taxonomy%3AMus+musculus

Apply Anatomy filter (blood and Adipose tissue):
http://localhost:3002/data/c2m2/search/liver?p=1&t=dcc%3AUCSD+Metabolomics+Workbench%7Cncbi_taxonomy%3AHomo+sapiens%7Cncbi_taxonomy%3AMus+musculus%7Canatomy%3Ablood%7Canatomy%3Aadipose+tissue
...
http://localhost:3002/data/c2m2/search/liver?t=dcc%3AIlluminating+the+Druggable+Genome%7Cdisease%3Aliver+cancer&p=1
...
http://localhost:3002/data/c2m2/search/parkinson?p=1&t=disease%3AAlzheimer%27s+disease
...
http://localhost:3002/data/c2m2/search/sterol?p=1&t=dcc%3AIlluminating+the+Druggable+Genome
...
http://localhost:3002/data/c2m2/search/sterol?p=1&t=dcc%3ALibrary+of+Integrated+Network-based+Cellular+Signatures
...
http://localhost:3002/data/c2m2/search/sterol?p=1&t=dcc%3AUCSD+Metabolomics+Workbench
...
http://localhost:3002/data/c2m2/search/sterol?p=1&t=anatomy%3Ablood+serum%7Canatomy%3Aadipose+tissue
...
### Search: atorvastatin
http://localhost:3002/data/c2m2/search/atorvastatin?p=1
...
OR
http://localhost:3002/data/c2m2/search/myeloid%20cell?t=biofluid%3Ablood&p=1

#### Apply filter taxonomy Homo sapiens
http://localhost:3002/data/c2m2/search/myeloid%20cell?p=1&t=ncbi_taxonomy%3AHomo+sapiens

#### then disease cancer
http://localhost:3002/data/c2m2/search/myeloid%20cell?p=1&t=ncbi_taxonomy%3AHomo+sapiens%7Cdisease%3Acancer

#### Another set of filters:
http://localhost:3002/data/c2m2/search/myeloid%20cell?p=1&t=ncbi_taxonomy%3AHomo+sapiens%7Cdisease%3Acancer%7Cdcc%3AThe+Gabriella+Miller+Kids+First+Pediatric+Research+Program
...
or
http://localhost:3002/data/c2m2/search/throat%20cancer?t=biofluid%3Asaliva&p=1
...
http://localhost:3002/data/c2m2/search/blood?p=1&t=ncbi_taxonomy%3AHomo+sapiens|ncbi_taxonomy%3AMus+musculus

Then apply DCC filter (select several values):
http://localhost:3002/data/c2m2/search/blood?p=1&t=ncbi_taxonomy%3AHomo+sapiens%7Cncbi_taxonomy%3AMus+musculus%7Cdcc%3A4D+NUCLEOME+DATA+COORDINATION+AND+INTEGRATION+CENTER%7Cdcc%3ALibrary+of+Integrated+Network-based+Cellular+Signatures%7Cdcc%3AIlluminating+the+Druggable+Genome%7Cdcc%3AUCSD+Metabolomics+Workbench
...
http://localhost:3002/data/c2m2/search/hepatitis?t=dcc%3AIlluminating+the+Druggable+Genome%7Cdcc%3AUCSD+Metabolomics+Workbench%7Cdisease%3ABudd-Chiari+syndrome&p=1
...
http://localhost:3002/data/c2m2/search/malignant%20carcinoma?t=disease%3Aadrenal+cortex+cancer%7Cdisease%3Anasopharynx+carcinoma&p=1

### Search: doxorubicin
http://localhost:3002/data/c2m2/search/doxorubicin?t=disease%3Aobesity%7Cdisease%3Abreast+carcinoma&p=1
...
### Search: sleep apnea
http://localhost:3002/data/c2m2/search/sleep%20apnea?t=&p=1
...
### Search: vitiligo
http://localhost:3002/data/c2m2/search/vitiligo?t=dcc%3AGlyGen&p=1
...
http://localhost:3002/data/c2m2/search/islet%20of%20langerhans?t=&p=1

http://localhost:3002/data/c2m2/search/islet%20of%20langerhans?t=dcc%3AUCSD+Metabolomics+Workbench&p=1
...
http://localhost:3002/data/c2m2/search/melanoma?t=ncbi_taxonomy%3AHomo+sapiens&p=1
http://localhost:3002/data/c2m2/search/melanoma?t=ncbi_taxonomy%3AHomo+sapiens%7Canatomy%3Askin+of+body&p=1
...
http://localhost:3002/data/c2m2/search/triple%20negative%20breast%20cancer?t=ncbi_taxonomy%3AHomo+sapiens%7Canatomy%3Abreast&p=1
...
http://localhost:3002/data/c2m2/search/triple%20negative%20breast%20cancer?t=ncbi_taxonomy%3AHomo+sapiens%7Canatomy%3Abreast%7Cdata_type%3AGene+expression+profile&p=1
...
http://localhost:3002/data/c2m2/search/latino%20male%20down%20syndrome?t=dcc%3AThe+Gabriella+Miller+Kids+First+Pediatric+Research+Program|disease%3ADown+syndrome|ncbi_taxonomy%3AHomo+sapiens|subject_ethnicity%3AHispanic+or+Latino|subject_sex%3AMale|data_type%3AExpression+data&p=1
...
http://localhost:3002/data/c2m2/search/metabolic%20disease%20male?t=disease%3Aasthma%7Canatomy%3Alung&p=1
...
http://localhost:3002/data/c2m2/search/sepsis?p=1&t=ncbi_taxonomy%3AHomo+sapiens%7Cncbi_taxonomy%3AMus+musculus%7Cbiofluid%3Ablood%7Cbiofluid%3Aperitoneal+fluid%7Cfile_format%3ATextual+format

### Search for mitochondria and apply filters
http://localhost:3002/data/c2m2/search/mitochondria?p=1&t=ncbi_taxonomy%3AHomo+sapiens%7Cprotein%3AHUMMR_HUMAN%7Cprotein%3ADBLOH_HUMAN

### Search for schizophrenia and add filters:
http://localhost:3002/data/c2m2/search/schizophrenia?p=1&t=data_type%3AMass+spectrometry+data

### Search for celiac disease and apply filters:
http://localhost:3002/data/c2m2/search/celiac%20disease?t=anatomy%3Amyenteric+nerve+plexus%7Cdata_type%3AGene+expression+profile&p=1

### Search for mitral valve and apply filters
http://localhost:3002/data/c2m2/search/mitral%20valve?t=anatomy%3Aleft+cardiac+atrium%7Cassay_type%3AChIP-seq+assay%7Cassay_type%3Achromatin+interaction+analysis+by+paired-end+tag+sequencing+assay&p=1

### Search for aorta and apply filters
http://localhost:3002/data/c2m2/search/aorta?t=anatomy%3Aascending+aorta&p=1
...
http://localhost:3002/data/c2m2/search/ChIP%20seq?t=disease%3Acancer&p=1

### Search for mass spectrometry and apply filters:
http://localhost:3002/data/c2m2/search/mass%20spectrometry?t=assay_type%3Atargeted%2C+drug-modulated%2C+mass+spectrometry-based+protein+phoshporylation-state+assay&p=1

### Search for menstrual cycle and add filters:
http://localhost:3002/data/c2m2/search/menstrual%20cycle?t=compound%3AAcetaminophen&p=1

## PTM-related test queries

### Search for liver and apply filters for PTM typs, subtype and site
http://localhost:3002/data/c2m2/search/liver?t=ptm_type%3Aprotein+glycosylation%7Cptm_subtype%3Aprotein+N-linked+glycosylation&p=1
...
http://localhost:3002/data/c2m2/search/parkinson?t=ptm_type%3Aprotein+phosphorylation&p=1
...
http://localhost:3002/data/c2m2/search/parkinson?t=ptm_type%3Aprotein+phosphorylation%7Cptm_subtype%3Apeptidyl-serine+phosphorylation&p=1
...
http://localhost:3002/data/c2m2/search/hepatitis?t=ncbi_taxonomy%3ABos+taurus%7Cptm_subtype%3Aprotein+N-linked+glycosylation&p=1
...
http://localhost:3002/data/c2m2/search/diabetes?t=ptm_type%3Aprotein+phosphorylation%7Cncbi_taxonomy%3AHomo+sapiens&p=1
...
http://localhost:3002/data/c2m2/search/blood?t=dcc%3AThe+Gabriella+Miller+Kids+First+Pediatric+Research+Program&p=1
