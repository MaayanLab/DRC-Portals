...
- [All reference tables](https://github.com/nih-cfde/published-documentation/tree/stable/reference_tables)
  - [disease_association_type](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/disease_association_type.tsv)
  - [phenotype_association_type](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/phenotype_association_type.tsv)   
  - [site_type](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/site_type.tsv)
  - [subject_ethnicity](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/subject_ethnicity.tsv)
  - [subject_granularity](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/subject_granularity.tsv)   
  - [subject_race](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/subject_race.tsv)
  - [subject_role](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/subject_role.tsv)  
  - [subject_sex](https://github.com/nih-cfde/published-documentation/blob/stable/reference_tables/subject_sex.tsv) 
...
### Return to [Documentation](/data/documentation/.)
<br /><br />
