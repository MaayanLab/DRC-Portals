...
This FAIR metric checks whether a URL has been provided to a document that defines a data management plan for how the persistent identifier will be maintained. 
To improve this metric score, the digital object should be linked with a permanent URL (preferably a DOI or a similar resolvable identifier) and should provide instructions for how the URL will be maintained.
