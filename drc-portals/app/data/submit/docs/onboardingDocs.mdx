...
2. You will be sent a registration confirmation link to that email. If you do not find the link in your inbox, please also check your spam folder as the email may be sent there. 
        <center><img src="/img/submission_system/onboarding_email.png" width="70%"></img></center>
        ##### <center>  Figure 1: A screenshot of login page. </center>
...
Go the My Account page by clicking on the user icon on the top right of the screen and click on My Account. 
        <center><img src="/img/submission_system/FAQ_myaccount_1.png" width="70%"></img></center>
        ##### <center> Figure 2: A screenshot of Data Portal showing navigation to My Account page. </center>
