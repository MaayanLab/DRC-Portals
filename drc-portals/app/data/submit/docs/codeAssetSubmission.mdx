...
2. On the Code Assets Upload Form, fill out all the fields: 
    ...
    ![Filling in code asset information](../../../../public/img/submission_system/code_submit_1.png)
...
3. After clicking on the “Submit Form” button: 
    ...
    ![Successful code asset submission](../../../../public/img/submission_system/code_submit_2.png)
...
4. Details of your uploaded code asset should appear on the Uploaded Assets page. 
    ![Submitted code asset on Uploaded Asset page](../../../../public/img/submission_system/code_submit_3.png)
...
2. Enter the URL of the page that documents the DCC APIs. 
    ...
    ![Submitting an API code asset](../../../../public/img/submission_system/code_submit_4.png)
...
1. Before uploading, ensure that all your account information has been entered/is accurate on the My Account page
    ...
    ![Submitting an API code asset](../../../../public/img/submission_system/FAQ_myaccount_1.png)
