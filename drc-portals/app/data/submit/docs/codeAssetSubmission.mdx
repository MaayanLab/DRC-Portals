...
2. On the Code Assets Upload Form, fill out all the fields: 
    ...
    - Select the code asset type you wish to submit from the available options ETL, API, PWB Metanode, Entity Page Template, Models and Apps URL. If submitting an API asset. Please see the API Code Asset Submission Steps section
