...
# example
(S)-Methylmalonate Semialdehyde		ALDH3A2	ALDH7A1	ALDH6A1	HIBADH	ALDH1B1	ALDH2	AOX1	EHHADH	ALDH9A1	HADH
```

<br/>Note that if description is left blank, the set label and entities are separated by two tabs.
