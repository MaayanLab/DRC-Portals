  ...
  <Grid container spacing={1} alignItems='stretch'>
    <Grid item xs={12} md={3}>
      <Stack spacing={3} sx={{marginTop: {xs: 1, md: 1}}}>
        ...
        <Button 
          sx={{width: "100%", height: 80, alignItems: "center", textAlign: "center"}} 
          variant="contained" 
          color="secondary" 
        ...
        >
          <Typography variant="h4">{inputList.length === 0 ? "Enter a biomedical entity to get started": "Submit"}</Typography>
      </Button>
      </Box>
    ...
    <Grid item xs={12} sx={{display: {xl: 'none', lg: 'none', md: 'none', sm: 'block', xs: 'block',}}} >
      <Button 
