  ...
  useEffect(() => {
    setNodes([
      ...
      },
      {
        id: 'cell',
        type: 'node',
        data: {  examples: ["liver", "kidney", "MCF-7"], label: "Cell types, Tissues, and Organ", update_input, facet: 'anatomy', icon: mdiEye, },
  ...
  <Grid container spacing={1} alignItems='stretch'>
    <Grid item xs={12}>
      <Stack justifyContent={"center"} alignItems="center" spacing={1}>
        <Typography variant="h1" color={'#2D5986'}>Explore NIH Common Fund Data and Tools</Typography>
        <Typography variant="subtitle1" color={'secondary'}>
         Leverage knowledge generated by Common Fund programs for your own research
        </Typography>
      ...
      <div className='flex justify-center'>
        <div>
          <Button 
              ...
              // }}
              href={`/explorer?q=${JSON.stringify(query)}&search=true`}
              disabled={inputList.length === 0}
            >
              <Typography variant="h5">{inputList.length === 0 ? "Enter one or more biomedical entity to get started": "Submit"}</Typography>
          </Button>
        </div>
      </div>
    </Grid>
