  ...
  return (
    <Grid container direction="row">
      ...
      <Grid item xs={12} sx={{mt:3, mb:4}}>
          ...
          <StyledAccordion >
            <StyledAccordionSummary>
              <Typography fontWeight="bold">Graph Query Interface</Typography>
            </StyledAccordionSummary>
            <StyledAccordionDetails >
              <Typography sx={{m:2}} color="#666666">
                The CFDE C2M2 Graph Query Interface lets you explore CFDE datasets
                through an intuitive visual graph search powered by Neo4j — no query
