...
* [External Tutorials and Examples](#tutorials-and-examples)
...
C2M2 metadata is harmonized with various standard biomedical ontologies. While including ontological metadata annotations is optional, it is highly recommended in order to facilitate increased interoperability across datapackages, which is one of the overall goals of the C2M2. 
...
- Ontology for Biomedical Investigations (OBI) - `file.assay_type`, `file.analysis_type`, `biosample.sample_prep_method`
- EDAM: `file.file_format`, `file.compression_format`, `file.data_type`
- Uber-Anatomy Ontology (UBERON): `biosample.anatomy`
- NCBI Taxonomy: `ncbi_taxonomy.id`
- Disease Ontology (DOID): `biosample_disease`, `sample_disease`
