...
export const PROPERTY_MAP: ReadonlyMap<string, string[]> = new Map([
  ...
  [
    ANALYSIS_TYPE_LABEL,
    [NAME_PROPERTY, SYNONYMS_PROPERTY, ID_PROPERTY, DESCRIPTION_PROPERTY],
  ],
  [
    ANATOMY_LABEL,
    [NAME_PROPERTY, ID_PROPERTY, DESCRIPTION_PROPERTY, SYNONYMS_PROPERTY],
  ],
  [
    ASSAY_TYPE_LABEL,
    [NAME_PROPERTY, SYNONYMS_PROPERTY, ID_PROPERTY, DESCRIPTION_PROPERTY],
  ...
  [
    PROTEIN_LABEL,
    [NAME_PROPERTY, ID_PROPERTY, SYNONYMS_PROPERTY, DESCRIPTION_PROPERTY],
  ],
  [
    SAMPLE_PREP_METHOD_LABEL,
    [NAME_PROPERTY, DESCRIPTION_PROPERTY, SYNONYMS_PROPERTY, ID_PROPERTY],
  ...
  [SUBSTANCE_LABEL, [NAME_PROPERTY, SYNONYMS_PROPERTY, ID_PROPERTY]],
  [
    BIOSAMPLE_LABEL,
    [PERSISTENT_ID_PROPERTY, LOCAL_ID_PROPERTY, CREATION_TIME_PROPERTY],
  ],
  [
    FILE_LABEL,
    [
