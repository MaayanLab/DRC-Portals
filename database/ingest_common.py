...
dcc_publications_path = ensure_file_factory('https://cfde-drc.s3.amazonaws.com/database/publication_files/current_dcc_publications.tsv', 'dcc_publications.tsv')
publications_path = ensure_file_factory('https://cfde-drc.s3.amazonaws.com/database/publication_files/current_publications.tsv', 'publications.tsv')
...
partnership_publications_path = ensure_file_factory('https://cfde-drc.s3.amazonaws.com/database/publication_files/current_partnership_publications.tsv', 'partnership_publications.tsv')
