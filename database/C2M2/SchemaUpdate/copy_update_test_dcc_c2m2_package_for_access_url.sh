...
# ./copy_update_test_dcc_c2m2_package_for_access_url.sh \
...
# append_random_access_url_to_file.sh \
...
schema_json_file=C2M2_datapackage_file_access_url.json
...
if [[ "$onlyTest" == "0" ]]; then
	...
	#cp "${schemaupdate_dir}/empty_tsvs"/*biofluid* . # Not for access_url test
	cp "${schemaupdate_dir}"/${schema_json_file} ./C2M2_datapackage.json
