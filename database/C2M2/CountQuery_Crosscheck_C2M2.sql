...
select count(*) from c2m2.file where id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.collection where id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.subject_in_collection where subject_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.biosample_from_subject where biosample_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.biosample where id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.file_describes_collection where file_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.project_in_project where parent_project_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.biosample_in_collection where biosample_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.file_in_collection where file_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.collection_defined_by_project where collection_id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.subject where id_namespace IN ('tag:hubmapconsortium.org,2023:');
select count(*) from c2m2.project where id_namespace IN ('tag:hubmapconsortium.org,2023:');
/* =============== DCC short label: IDG =============== */
