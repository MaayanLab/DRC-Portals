...
CREATE TEXT INDEX node_text_index_Collection_persistent_id IF NOT EXISTS FOR (n:Collection) ON (n.persistent_id);
CREATE TEXT INDEX node_text_index_Project_persistent_id IF NOT EXISTS FOR (n:Project) ON (n.persistent_id);
