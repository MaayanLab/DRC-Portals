...
my $compoundSynList = '../GlyTouCan-Aug-2025/002_GlyTouCan_IDs_to_add_to_pubchem_records_as_synonyms/add_compound_synonyms.tsv';
...
my $pubchemCompoundFile = '../PubChem-Aug-2025/001_stupidly_large_reference_tables/compound.2025-08-11.tsv.gz';
