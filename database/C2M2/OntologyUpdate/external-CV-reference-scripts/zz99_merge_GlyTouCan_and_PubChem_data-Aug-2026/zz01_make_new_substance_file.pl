...
my $substanceSynList = '../GlyTouCan-Aug-2026/002_GlyTouCan_IDs_to_add_to_pubchem_records_as_synonyms/add_substance_synonyms.tsv';
if (defined $ARGV[0]) {
...
my $pubchemSubstanceFile = '../PubChem-Aug-2026/001_stupidly_large_reference_tables/substance.2026-07-27.tsv.gz';
if (defined $ARGV[1]) {
