...
my $substanceSynList = '../GlyTouCan-Nov-2024/002_GlyTouCan_IDs_to_add_to_pubchem_records_as_synonyms/add_substance_synonyms.tsv';

#my $pubchemSubstanceFile = '../PubChem_preprocessing/001_stupidly_large_reference_tables/substance.tsv.gz';
my $pubchemSubstanceFile = '../PubChem-Nov-2024/001_stupidly_large_reference_tables/substance.2024-11-12.tsv.gz';
