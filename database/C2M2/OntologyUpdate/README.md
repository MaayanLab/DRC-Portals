## Setting up C2M2 OntologyUpdate

```bash
# README.md file for OntologyUpdate 

# Be in the folder database/C2M2/OntologyUpdate
...
# Use this file to record the commands that need to be executed for updating one or more ontology files
