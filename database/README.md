...
dbport=5433
mkdir -p log
psql -h localhost -U drc -d drc -p ${dbport} -a -f create_id_namespace_dcc_id.sql -o log/log_create_id_namespace_dcc_id.log
...
psql -h localhost -U drc -d drc -p ${dbport} -a -f ingest_CV.sql
...
psql -h localhost -U drc -d drc -p ${dbport} -a -f c2m2_other_tables.sql -o log/log_c2m2_other_tables.log
...
psql -h localhost -U drc -d drc -p ${dbport} -a -f biosample_fully_flattened_allin1.sql;

# Also generate c2m2.ffl_collection
psql -h localhost -U drc -d drc -p ${dbport} -a -f collection_fully_flattened_allin1.sql;

# Combine c2m2.ffl_biosample and c2m2.ffl_collection to create c2m2.ffl_biosample_collection
psql -h localhost -U drc -d drc -p ${dbport} -a -f c2m2_combine_biosample_collection.sql -o log/log_c2m2_combine_biosample_collection.log
...
psql -h localhost -U drc -d drc -p ${dbport} -a -f ingest_slim.sql
